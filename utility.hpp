...
//EFFECTS: Determines the key of a given progression
//Note: Different from getKey() because that gets the key of a given chord
...
//EFFECTS: Outputs information about the major V-I progression
//note: only needs chord2Key becayse that can alone be used to
//determine the key of the progression
